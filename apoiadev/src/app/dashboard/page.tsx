...
import { getLoginOnboardAccont } from "./data-access/create-onboard-account";
import { CreateAccontButton } from "./_components/create-account-button";
...
export default async function Dashboard() {
  ...
  const accountUrl = await getLoginOnboardAccont(session.user.connectedStripeAccountId)
